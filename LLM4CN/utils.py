...
client = OpenAI(
    api_key="sk-zk2a11ef9b2eb3c7f05cef07fb54890df90688db07fe4d60",
    base_url="https://api.zhizengzeng.com/v1"  # ✅ 指定代理地址
)
Input_35 = 0.001
Output_35 = 0.002
...
def LLM_generate_algorithm(prompt, stochasticity=1):
    while True:
        # 使用新 SDK 的 client.chat.completions.create
